...
const pages: Page[] = [
  ...
  { path: '/search-runs', name: 'search runs', authenticated: true },
  { path: '/resources', name: 'resources', authenticated: true },
  { path: '/donations', name: 'donations', authenticated: true },
  { path: '/playground', name: 'playground', authenticated: true }
];
